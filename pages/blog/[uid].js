    ...
    return (
      <DefaultLayout>
        ...
        <div className="main">
          ...
          {post.data.body.map(element => {
            if (element.type === "paragraph") return <p>{element.text}</p>
            else if (element.type === "image") {
              console.log(element.dimensions.width);
              return <img src={element.url} alt={element.alt || ""} width={element.dimensions.width} height={element.dimensions.height} />
            }
          })}
